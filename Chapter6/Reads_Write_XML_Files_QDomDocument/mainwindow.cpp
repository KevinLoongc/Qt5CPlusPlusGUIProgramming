...
void MainWindow::on_saveXmlButton_clicked()
{
    ...
    QDomText    textAddress = xml.createTextNode("114B, 2nd Floor, Sterling Apartment");
    tagAddress.appendChild(textAddress);

    QDomElement tagPhone = xml.createElement("phone");
    root.appendChild(tagPhone);
    QDomText    textPhone = xml.createTextNode("022175468246");
    ...
    QDomText    textPhone2 = xml.createTextNode("00245864537");
